function [] = plot_TextGrid(filenameTG, filenameW, label, binsiz, timestart)
% plot activity versus time for the label input
% example:
% plot_TextGrid('~/Documents/Students/Ben_Reed/MOKO1_20140925_180000.TextGrid','~/Documents/bioacoustics/recordings/Burgess_Sept2014/Plot1/MOKO1_20140925_180000.wav','diving_petrel',60,'25/09/2014 18:00:00');
% plot_TextGrid('~/Documents/Students/Ben_Reed/MOKO1_20140926_004553.TextGrid','~/Documents/bioacoustics/recordings/Burgess_Sept2014/Plot1/MOKO1_20140926_004553.wav','diving_petrel',60,'26/09/2014 00:45:53');
...
[y, Fs] = wavread(filenameW,1);
length1 = wavread(filenameW, "size");

tmp = regexprep(filenameTG(end:-1:1),'dirGtxeT.','flm.','once');
tmp = tmp(end:-1:1); % allows to replace just once, the last one
textGrid2mlf( filenameTG, tmp ) ;
